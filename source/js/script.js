...
function computerPlay () {  // get random number from 1-3
    const computerSelection = Math.floor(Math.random() * (4 - 1) + 1); //1 == rock, 2 == paper, 3 == scissors
    return;
}
...
function beginPlay(){
    ...
    setTimeout(
        ...
        setTimeout(
            ...
            setTimeout(
                () => { 
                    visbilityToggle("play-button");playerPlay();
